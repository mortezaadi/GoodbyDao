 ...
 *
 * @param <E>   Entity extended IEntity
 * @param <I>   Serializable Object as a PrimeryKey
 */
public interface IDao<E extends IEntity<I>, I extends Serializable> {
	 ...
	 * collections type. in next release Collection should be handled! P.S I
	 * hope! :)
	 * 
	 * @param example
	 *            sample object
	...
	/**
	 * save an Object extended {@link IEntity} to database. if Object's Id is
	 * not null merges the entity.
	 * 
	 * @param object
	...
	/**
	 * save Objects extended {@link IEntity} to database. if Object's Id is
	 * not null merges the entity.
	 * 
	 * @param objects
	...
	/**
	 * save List of Objects extended {@link IEntity} to database. if Object's Id is
	 * not null merges the entity.
	 * 
	 * @param objects
	 *            Objects extended {@link IEntity}
	 ...
	 * @param object An dirty object.
	 * @param properties array of property names.
	 * @throws IllegalAccessException if access to field is restricted.
	 * @throws IllegalArgumentException  if null or invalid data passed in.
	 */
	void updateOne(E object, String... properties) throws IllegalArgumentException, IllegalAccessException;
